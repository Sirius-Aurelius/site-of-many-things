---
{"dg-publish":true,"permalink":"/dm-screen/rules/variant-rules/schools-of-magic-divination/"}
---
...
*(Refer to [[Spells/0 Legilimens & Occlumens\|Legilimens & Occlumens]] for further details)*

## School of Magic Abilities

| Required Level | Ability                                                          |
| -------------- | ---------------------------------------------------------------- |
| 2nd            | [[DM SCREEN/RULES/Variant Rules/Schools of Magic - Divination#Cleromancy\|Cleromancy]]         |
| 3rd            | [[DM SCREEN/RULES/Variant Rules/Schools of Magic - Divination#Tasseomancy\|Tasseomancy]]       |
| 7th            | [[DM SCREEN/RULES/Variant Rules/Schools of Magic - Divination#Cartomancy\|Cartomancy]]         |
| 9th            | [[DM SCREEN/RULES/Variant Rules/Schools of Magic - Divination#Crystal-gazing\|Crystal Gazing]] |
...
* **Legilimency.** You add the [[Spells/Legilimens\|Legilimens]] spell to your list of known spells. It does not count against your number of spells known, and cannot be forgotten to learn another spell.
...
* **Skilled Occlumens.** [[Spells/Legilimens\|Legilimens]] and veritaserum will not work on you, unless you allow it. You can choose to let legilimens continue and reveal false information, false emotions, or false memories of your choosing.
...
* **Darting Eyes.** Legilimency required. As a bonus action, you can cast [[Spells/Legilimens\|Legilimens]] in combat to see the next spell or action a creature is planning, as long as their eyes are visible.
