...
## (Thorne's) Elixir of the Eternal Sentinel
_Potion, Rare_

**Description:** This vibrant, pulsing violet liquid smells faintly of ozone and strong espresso. It is designed for wizards who must remain vigilant when sanctuary is unavailable.

**Effect:** Upon drinking this potion, you gain the following benefits immediately:
• **Resource Restoration:** You regain all spent **Sorcery Points**.
• **Vitality:** You regain all spent **Hit Dice**.
• **Recovery:** You remove up to **two levels of exhaustion**.
• **Vigilance:** For the next 8 hours, you cannot be surprised while conscious, and you do not require sleep.

**The Crash (Drawback):** The magical tax of skipping rest is severe. Exactly 8 hours after consumption, the drinker must succeed on a **DC 15 Constitution saving throw**. On a failure, they immediately gain **3 levels of exhaustion** and fall into a **magical sleep** (as per the [[1 DIGITAL GARDEN/4.0 Potions/Sleeping Draught\|Sleeping Draught]]) for 4 hours. On a success, they gain only 1 level of exhaustion and remain awake.

**Ingredients:**
• **1 Bundle of Thaumatagoria:** (Very Rare) Found where reality is thin; provides the power to "cheat" time.
• **1 Flask of Re'em Blood:** (Uncommon) Grants immense strength and stamina.
• **1 Sloth Brain:** (Rare) Paradoxically used here to focus the mind against the need for rest.
• **1 Vial of African Sea Salt:** (Rare) Acts as a powerful preservative for the body's energy.

**Potion Effectiveness**

| Proficiency | Ingredient Quality | Potion Result                                                                                                    |
| ----------- | ------------------ | ---------------------------------------------------------------------------------------------------------------- |
| None        | Poor               | **Flawed:** Restores only half of max Sorcery Points; the "Crash" DC is 18.                                      |
| One         | Normal             | **Normal:** As described above.                                                                                  |
| Both        | Superior           | **Exceptional:** Restores all Hit Points in addition to other effects; the "Crash" does not cause magical sleep. |
